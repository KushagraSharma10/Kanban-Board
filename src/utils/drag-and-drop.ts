...
export function moveItemWithinList<T>(list: T[], fromIndex: number, toIndex: number): T[] {
...
export function reorderById<T extends { id: string }>(
  ...
  const adjustedIndex = sourceIndex < targetIndex ? intendedIndex - 1 : intendedIndex;
